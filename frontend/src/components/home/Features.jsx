...
>
            From extracting report data to generating easy-to-understand
            explanations, MedExplain AI simplifies every step of understanding
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {features.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className={`${theme.card} group p-8 rounded-3xl hover:-translate-y-1`}
              >
                <div
                ...
                <h3 className={`${theme.heading} text-xl font-bold mb-3 group-hover:text-blue-600 transition-colors`}>
                  {feature.title}
                </h3>
