        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-8 items-center">
          ...
          <div className="flex flex-col items-start text-left max-w-2xl">
            ...
            <p className="text-lg text-slate-600 mb-8 max-w-lg leading-relaxed">
              Upload your lab results or medical reports and get simple,
              easy-to-understand explanations in seconds. Stop guessing and
              ...
              >
                ...
                {uploadStatus === "idle" && (
                  <>
                    ...
                    <div className="flex gap-2">
                      <span className="px-2 py-1 bg-white border border-slate-200 rounded md text-xs font-medium text-slate-500 shadow-sm">
                        PDF
                      </span>
                      <span className="px-2 py-1 bg-white border border-slate-200 rounded md text-xs font-medium text-slate-500 shadow-sm">
                        PNG
                ...
                {uploadStatus === "analyzing" && selectedFile && (
                  <>
                    ...
                    <p className="text-slate-700 font-medium text-center truncate max-w-full px-4">
                      {selectedFile.name}
                    </p>
